...
<html lang="en">
  ...
  <body>
    ...
    <div class="container p-4 card card-body">
      <h3 class="text-center">Sistema de Control Becario</h3>
      <img src="imagenes/UADY_logo.png" class="img-fluid imgIndex" alt="Responsive image" />
      <h2 class="text-center" >Informacion</h2>
      <p class="text-center" >
        Becario, favor de inicion sesion con la cuenta suministrada por el
        administrador, de no contar con una favor de solicitarla con el mismo
      </p>
