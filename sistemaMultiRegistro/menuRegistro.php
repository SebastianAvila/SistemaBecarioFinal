    ...
    <div class="d-flex" id="wrapper">
      ...
      <div class="bg-light border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
          <a href="registroAlumnos.php" class="list-group-item list-group-item-action bg-light"
            >Registro Alumnos</a
          >
          <a href="registroPrograma.php" class="list-group-item list-group-item-action bg-light"
            >Registro Programas</a
          >
